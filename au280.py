...
# Modified for Alveo U280 board by Sergiu Mosanu <sm7ed@virginia.edu>
# License: BSD
...
# -------------------------
# ./au280.py --build --with-hbm #--load (load not tested)
# lxterm /dev/ttyUSB4 --speed=115200 to interface with the UART
# Tested with Vivado 2019.2.1
...
_io = [
    ...
    # not tested with LEDs because of board issue
...
class Platform(XilinxPlatform):
    ...
    def __init__(self):
        XilinxPlatform.__init__(self, "xcu280-fsvh2892-2L-e-es1", _io, toolchain="vivado")
...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=int(250e6), with_hbm=False, with_analyzer=False, **kwargs):
        ...
        # SoCCore ----------------------------------------------------------------------------------
        kwargs["uart_name"] = "serial" #"crossover" # will use serial port
        SoCCore.__init__(self, platform, sys_clk_freq,
            ident          = "LiteX HBM2 Test SoC on Alveo U280 ES1.",
            ident_version  = True,
            **kwargs)
...
def main():
    parser = argparse.ArgumentParser(description="LiteX HBM2 Test SoC on Alveo U280.")
    ...
    builder = Builder(soc, output_dir="build/au280", csr_csv="csr.csv")
